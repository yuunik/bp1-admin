...
<template>
  <section class="h-full">
    ...
    <div class="py-16 px-32 flex-between">
      <h3 class="heading-h2-20px-medium neutrals-off-black">1111111</h3>
    ...
    <div>
      ...
      <div class="px-32 pt-16 pb-24 flex gap-24">
        ...
        <div class="flex-1 w-400 h-80 flex gap-24">
          <!-- logo -->
          <el-image
            src="src/assets/icons/fi_like.svg"
            fit="cover"
            class="w-64 h-64"
            loading="lazy"
          >
            <template #error>12312</template>
          </el-image>
          <!-- desc -->
        ...
        <div class="flex-1 w-384 h-80 flex flex-col gap-4">
          ...
          <div class="flex gap-8">
            ...
            <!-- 值 -->
            <el-text class="w-264 h-32">{22222</el-text>
          </div>
          <!-- 状态 -->
          <div class="flex gap-8">
            <!-- 标签 -->
