...
const obdDeviceList = ref([
  {
    ...
    sn: '1234567890',
    status: 'Active',
    lastUsed: '15 May 2025 9:00 am',
    vehicle: 'Ralph Edwards',
  },
  {
    model: 'OBD-1',
    sn: '1234567890',
...
<template>
  <section class="flex flex-col gap-16">
    ...
    >
      <dt>Email</dt>
      <dd>tim.jennings@example.com</dd>
      <dt>Registration Date</dt>
      <dd>04 Apr 2025 4:23pm</dd>
      <dt>Subscription</dt>
      <dd>Monthly Pro</dd>
      <dt>Last Login</dt>
      <dd>20 Apr 2025 (5 days ago)</dd>
      <dt>Status</dt>
      <dd>
    ...
    <div class="flex flex-col gap-8" v-if="obdDeviceList.length">
      ...
      <div class="mx-32">
        <el-table :data="obdDeviceList">
          ...
          <el-table-column prop="lastUsed" label="Last Used" />
          <el-table-column prop="vehicle" label="Vehicle" />
          <el-table-column>
            <template #default="{ row }">
              <el-button class="rounded-full!" v-if="row.status === 'Active'">
                Unbind
              </el-button>
            </template>
          </el-table-column>
    ...
    <div class="flex flex-col gap-8" v-if="vehicleList.length">
      ...
      <div class="mx-32">
        <el-table :data="vehicleList">
          ...
          <el-table-column prop="bindDate" label="Bind Date" />
          <el-table-column>
            <template #default="{ row }">
